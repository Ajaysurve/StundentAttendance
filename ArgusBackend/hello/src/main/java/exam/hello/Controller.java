...
public class Controller {
	...
	@PostMapping("/alogin") //-----------Student Login
	public int getAdminLogin(@RequestBody Admin aobj)
	{
		System.out.println(aobj);
		
		int x =obj1.doAdminLogin(aobj);
		return x;	
	}
	
	@GetMapping("/delmsg")
	public int servdelmsg(@RequestParam("id") int uid)
	{
		System.out.println("Inside Controler");
		int y = obj1.delmsg(uid);
		return y ;
	}
